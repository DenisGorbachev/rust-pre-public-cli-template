...
const cargoSearchOutput = await $`cargo search ${name}`
const isPublished = cargoSearchOutput.length > 0
...
${isPublished ? `[![Documentation](https://docs.rs/${name}/badge.svg)](https://docs.rs/${name})` : ''}
